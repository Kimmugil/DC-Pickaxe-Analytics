            ...
            {combined.map(item => {
              if (item.type === 'weekly') {
                return (
                  ...
                  >
                    <span className="text-[11px] font-medium text-blue-600 bg-blue-50 px-2 py-0.5 rounded mt-0.5 shrink-0">
                      {t['reports.badge_weekly'] ?? '주간'}
                    </span>
                    ...
                    <span className="text-gray-300 group-hover:text-gray-500 text-sm shrink-0 self-center transition-colors">→</span>
                  </Link>
                )
              }
                ...
                >
                  <span
                    className={`text-[11px] font-medium px-2 py-0.5 rounded mt-0.5 shrink-0 ${
                      hasHighIssue ? 'text-red-600 bg-red-50' : 'text-orange-600 bg-orange-50'
                    }`}
                  >
                    {t['reports.badge_issue'] ?? '이슈'}
                  </span>
                  <div className="min-w-0 flex-1">
                    <div className="flex items-center justify-between gap-2">
