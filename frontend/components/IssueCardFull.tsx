    ...
    <div className="bg-white border border-gray-200 rounded-lg p-4 space-y-3">
      ...
      {collapsible && hasDetails && (
        <button
          ...
          className="w-full mt-1 py-2 rounded-md border border-gray-200 bg-gray-50 hover:bg-gray-100 hover:border-gray-300 flex items-center justify-center gap-1.5 text-xs font-medium text-gray-500 hover:text-gray-700 transition-all"
        >
          <span>
            {expanded
              ? (t['common.collapse'] ?? '접기')
              : (t['common.expand'] ?? '키워드 · 게시글 보기')}
          </span>
          <svg
